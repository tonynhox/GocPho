...
export const fetchGetAddress = createAsyncThunk(
  ...
  async _id => {
    ...
    const url = `http://gocpho.huyta.codes/user/get-profile`;
    const body = {
      _id: _id,
    };
...
export const fetchRemoveAddress = createAsyncThunk(
  ...
  async ({_id, idAddress}) => {
    ...
    const url = `http://gocpho.huyta.codes/user/delete-address`;
    const body = {
      _id: _id,
      idAddress: idAddress
    };
...
export const fetchChangeAddress = createAsyncThunk(
  ...
  async ({_id, idAddress, newAddress}) => {
    ...
    const url = `http://gocpho.huyta.codes/user/edit-address`;
    const body = {
      _id: _id,
      idAddress: idAddress,
...
export const fetchNewAddress = createAsyncThunk(
  ...
  async ({_id, address}) => {
    ...
    const url = `http://gocpho.huyta.codes/user/add-address`;
    const body = {
      _id: _id,
      address: address,
    };
...
export const fetchChangeStatusAddress = createAsyncThunk(
  ...
  async ({_id, idAddress}) => {
    ...
    const url = `http://gocpho.huyta.codes/user/set-status-address`;
    const body = {
      _id: _id,
      idAddress: idAddress,
    };
