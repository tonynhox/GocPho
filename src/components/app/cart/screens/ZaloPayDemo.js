...
import { StyleSheet,LogBox, Text,TextInput,ToastAndroid, ScrollView, KeyboardAvoidingView, NativeModules, NativeEventEmitter,Button } from 'react-native';
...
const subscription = payZaloBridgeEmitter.addListener(
  ...
  (data) => {
    if (data.returnCode == 1) {
      alert('Pay success!');
      ToastAndroid.show('Pay success!!', ToastAndroid.SHORT);
    } else if (data.returnCode == -1) {
      alert('Pay errror! ' + data.returnCode);
      ToastAndroid.show('Pay error!!', ToastAndroid.SHORT);
    }else{
      alert('Pay Cancel! ' + data.returnCode);
      ToastAndroid.show('Pay cancel!!', ToastAndroid.SHORT);
